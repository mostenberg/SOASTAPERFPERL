...
'
		...
		$results=<FILE>;
		$results=~ /resultSet:"(.*)",shouldIssueRepoll:false,stillRunning:false/; #ResultSet is the stuff between 'resultSet:"'  and ',stillRunning:false
		$resultSet=$1;
		print $resultSet;
